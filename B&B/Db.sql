...
INSERT INTO
    `camere`(`Numero`, `Descrizione`, `Posti`)
VALUES
    (1, "Ciclamini", 3),
    (2, "Rose", 2),
    (3, "Girasoli", 4),
...
VALUES
    (1, "1", 1, "2021-07-15", "2021-07-31", 0),
    (2, "2", 2, "2021-07-01", "2021-07-31", 0),
    (3, "3", 3, "2021-06-25", "2021-07-25", 0),
    (4, "1", 1, "2021-12-01", "2021-12-31", 0)
INSERT INTO
    `soggiorni`(`Prenotazione`, `Cliente`, `Documento`)
VALUES
    (1, 1, "CI"),
    (2, 2, "Patente"),
    (3, 1, "CI"),
